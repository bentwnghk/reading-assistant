...
CREATE TABLE reading_sessions (
  ...
  summary_language TEXT DEFAULT NULL,
  ...
  mind_map_language TEXT DEFAULT NULL,
  visualization_image TEXT DEFAULT '',
  visualization_generated_at BIGINT DEFAULT 0,
  visualization_language TEXT DEFAULT NULL,
  pre_reading JSONB,
  ...
  spelling_results JSONB DEFAULT '[]'::jsonb,
  grammar_results JSONB DEFAULT '[]'::jsonb,
