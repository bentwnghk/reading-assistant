-- Add grammar hot-streak achievement (On Fire for grammar games: 5+ correct
-- answers in a row within a single grammar game).
-- Run after add-spelling-achievements.sql (or after init-db.sql for fresh
-- installs, which already includes these values).

-- 1. New activity type for the activity log.
