...
**步驟三 — 開始閱讀**
上傳閱讀材料的照片，或從文本庫選擇文章，或使用AI生成。試試摘要、思維導圖、文本分析和改寫、詞彙或遊戲等功能。
