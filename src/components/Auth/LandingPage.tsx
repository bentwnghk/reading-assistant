    ...
    <div className="min-h-screen bg-[#FDFBF7] dark:bg-[#0D1117] text-slate-900 dark:text-slate-100 font-sans selection:bg-emerald-200 dark:selection:bg-emerald-900 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-3 group relative overflow-hidden bg-slate-900 dark:bg-slate-800 border border-slate-800 dark:border-slate-700 rounded-[2.5rem] p-10 text-white hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
            <div className="absolute -bottom-20 -right-10 p-8 opacity-10 group-hover:scale-110 transition-transform duration-500 group-hover:opacity-20">
              <Shield className="h-64 w-64 text-blue-400" />
            </div>
            <Shield className="relative z-10 h-12 w-12 mb-6 text-blue-400" />
            <h3 className="relative z-10 text-3xl font-bold mb-3">{t("header.about.whyLove.private.title")}</h3>
            <p className="relative z-10 text-xl text-slate-300 max-w-3xl leading-relaxed">{t("header.about.whyLove.private.desc")}</p>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { icon: MessageCircle, key: "tutor", color: "text-indigo-600 dark:text-indigo-400", bg: "bg-indigo-50 dark:bg-indigo-950/30", span: "sm:col-span-2" },
            ...
            { icon: Target, key: "test", color: "text-red-600 dark:text-red-400", bg: "bg-red-50 dark:bg-red-950/30", span: "sm:col-span-2 lg:col-span-2" },
          ...
          ].map(({ icon: Icon, key, color, bg, span }) => (
            <div key={key} className={`group flex flex-col p-8 rounded-[2.5rem] bg-white dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 ${span || ""}`}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap gap-4">
            {[
              ...
              { num: 4, icon: PenTool, key: "adapt" },
              { num: 5, icon: BarChart3, key: "difficulty" },
              { num: 6, icon: Highlighter, key: "cefrHighlight" },
              { num: 7, icon: MessageCircle, key: "tutor" },
              { num: 8, icon: Target, key: "test" },
              { num: 9, icon: MessageSquareText, key: "analyze" },
              { num: 10, icon: Zap, key: "highlight" },
              { num: 11, icon: BookOpen, key: "glossary" },
              { num: 12, icon: Gamepad2, key: "spelling" },
              { num: 13, icon: Layers, key: "vocabQuiz" },
