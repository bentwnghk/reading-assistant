    ...
    <div className="min-h-screen bg-[#FDFBF7] dark:bg-[#0D1117] text-slate-900 dark:text-slate-100 font-sans selection:bg-emerald-200 dark:selection:bg-emerald-900 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 group relative overflow-hidden bg-slate-900 dark:bg-slate-800 border border-slate-800 dark:border-slate-700 rounded-[2.5rem] p-10 text-white hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
