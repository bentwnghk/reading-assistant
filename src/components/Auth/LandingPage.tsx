  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] dark:bg-[#0D1117] text-slate-900 dark:text-slate-100 font-sans selection:bg-emerald-200 dark:selection:bg-emerald-900 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 text-center">
        ...
        <div className="relative max-w-3xl mx-auto text-center bg-gradient-to-b from-slate-50 to-white dark:from-slate-800 dark:to-slate-900 border border-slate-200 dark:border-slate-700/80 rounded-[2rem] sm:rounded-[3rem] md:rounded-[4rem] px-6 py-10 sm:p-12 md:p-16 shadow-2xl overflow-hidden">
