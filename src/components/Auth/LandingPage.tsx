    ...
    <div className="min-h-screen bg-[#FDFBF7] dark:bg-[#0D1117] text-slate-900 dark:text-slate-100 font-sans selection:bg-emerald-200 dark:selection:bg-emerald-900 overflow-hidden">
      ...
      <AnimatedSection className="relative z-10 py-24" staggerDelay={0.15}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <motion.div variants={gridContainer(0.4)} className="flex flex-wrap gap-4">
            {[
              { num: 1, icon: Upload, key: "upload" },
              { num: 2, icon: FileText, key: "summary" },
              { num: 3, icon: Brain, key: "mindmap" },
              { num: 4, icon: ImageIcon, key: "visualization" },
              { num: 5, icon: BarChart3, key: "difficulty" },
              { num: 6, icon: Highlighter, key: "cefrHighlight" },
              { num: 7, icon: PenTool, key: "adapt" },
              { num: 8, icon: MessageCircle, key: "tutor" },
              ...
              { num: 14, icon: Target, key: "test" },
              { num: 15, icon: BookOpenCheck, key: "grammar" },
              { num: 16, icon: Gamepad2, key: "grammarGames" },
              { num: 17, icon: Library, key: "myVocabulary" },
