  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        sessionData.visualizationLanguage ?? null,
...
export async function getUserSessions(userId: string): Promise<SessionWithImages[]> {
  ...
  try {
    ...
    return result.rows.map(row => ({
      ...
      summary: row.summary,
      summaryLanguage: row.summary_language ?? null,
      ...
      mindMapLanguage: row.mind_map_language ?? null,
...
export async function updateReadingSession(
  ...
  try {
    ...
    const fieldMappings: Record<string, string> = {
      ...
      mindMap: "mind_map",
      mindMapLanguage: "mind_map_language",
      visualizationImage: "visualization_image",
      visualizationLanguage: "visualization_language",
